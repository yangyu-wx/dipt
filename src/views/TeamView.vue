        ...
        <div class="members-grid">
          <div class="member-card" v-for="(member, index) in teamMembers" :key="index">
            <div class="member-image">
              <img :src="member.image" alt="" :alt="member.name">
            </div>
            <div class="member-info">
              ...
              <div class="member-areas">
                <span class="area-tag" v-for="(area, idx) in member.researchAreas" :key="idx">{{ area }}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      teamMembers: [
        {
          name: '刘海龙',
          title: '中心主任',
          image: '/images/mamber/liuhailong.jpg',
        ...
        },
        {
          name: '耿兴隆',
          title: '中心副主任',
          image: '/images/mamber/gengxinglong.jpg',
        ...
        },
        {
          name: '石彦芳',
          title: '中心副主任',
          image: '/images/mamber/shiyanfang.jpg',
        ...
        },
        {
          name: '刘丽华',
          title: '学术带头人',
          image: '/images/mamber/liulihua.jpg',
        ...
        },
        {
          name: '郝艳荣',
          title: '学术带头人',
          image: '/images/mamber/haoyanrong.jpg',
